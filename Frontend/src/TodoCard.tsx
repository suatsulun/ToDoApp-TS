    ...
    return(<div className="inline-block">
                ...
                <CardHeader>
                    <CardTitle className='w-max'>
                        <Input className="boder-1 border-black rounded-full" value={editText}
                    ...
                    <CardDescription>
                        <TodosType selectedType={editStatus} setSelectedType={setEditStatus} />
                    </CardDescription>
                </CardHeader>
                <CardFooter className="flex flex-col gap-2">
                    <Button className="w-full rounded-full" onClick={handleSave}><Check className="mr-2 h-4 w-4" /> Save</Button>
                    <Button className="border-1 border-red-600 rounded-full w-full" onClick={() => setIsEditing(false)} variant="outline">
                ...
                <CardFooter className="flex flex-col gap-2">
                    <Button className="w-full rounded-full" onClick={()=> setIsEditing(true)} >
                    <Edit className="mr-2 h-4 w-4" /> Edit</Button>
                    <Button className="border-1 border-red-600 rounded-full w-full" onClick={()=> handleDelete(todo.id)} variant="destructive">
